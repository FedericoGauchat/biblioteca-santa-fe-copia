...
import com.gob.biblioteca_santa_fe.repository.mysql.PrestamoRepository;
...
public class PrestamoSerivceImpl implements PrestamoService {
    ...
    public List<ResponseStoredDTO> getPrestamoPorEstado(String estado) {
        ...
        throw new UnsupportedOperationException("Unimplemented method 'getPrestamoPorEstado'");
    }
